...
CONTROLNET2_WEIGHT = float(os.getenv("CONTROLNET2_WEIGHT", "0.72"))
CONTROLNET2_GUIDANCE_START = float(os.getenv("CONTROLNET2_GUIDANCE_START", "0.02"))
CONTROLNET2_GUIDANCE_END = float(os.getenv("CONTROLNET2_GUIDANCE_END", "0.95"))
