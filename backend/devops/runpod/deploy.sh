...
export CONTROLNET_GUIDANCE_END=0.70     # taper off near the end to preserve texture
...
export CONTROLNET2_WEIGHT=1              # Secondary weight: start moderate; we’ll tune after wiring
export CONTROLNET2_GUIDANCE_START=0.00      # Let Canny kick in shortly after start and persist late to anchor buttons
export CONTROLNET2_GUIDANCE_END=0.80
